...
- OpenCode budget guard created this minimal continuity report because task reached a budget limit and there was not enough safe margin to request a model-written handoff.

## Budget State

- Session: $0.9334 / soft $0.4000 / hard $0.5000
- Task: $2.5006 / soft $2.0000 / hard $2.5000
- Counted session messages: 358
- Counted task messages: 1973
